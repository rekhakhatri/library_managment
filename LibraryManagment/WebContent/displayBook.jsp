...
%>	      	 
                   ...
                   %>
                          <tr>
                            ...
                            <td><%= publisher %></td>
                             <td>
                                <a href="displaySinglePage.jsp?id=<%= resultSet.getString("id")%>" class="btn btn-success btn-sm">View</a>
                                <a href="SingleBookDetail.jsp?id=<%= resultSet.getString("id")%>" class="btn btn-warning btn-sm">Issue</a>
                            </td>
                           </tr>  
                   <% 
                		}   
